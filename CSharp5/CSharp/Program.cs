...
namespace CSharp
{
    ...
    */
    ...
    public class LINQTestSuite : TestSuite, ITestSuite
    {
        ...
        private void LINQ_Basic()
        {
            ...
            /*IEnumerable<Customer>*/ var customers =
                ...
                from /*Customer*/ c in company.Customers
    ...
    {
        private static readonly string kNorthwindConnectionString = "Server=.\\SQLEXPRESS;Database=NORTHWND;Trusted_Connection=True;";
